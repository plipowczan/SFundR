...
The goal of this repository is to provide ShareFund web  application and API. Its choices of technology for things like data access are rooted in what is the most common, accessible technology for most business software developers using Microsoft's technology stack. Below is a list of the technology dependencies it includes, and why they were chosen.
